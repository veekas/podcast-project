...
export default class Player extends Component {
  ...
  setVolume = elem => {
    this.setState({ volume: parseFloat(elem.target.value) })
  }
  toggleMuted = () => {
    this.setState({ muted: !this.state.muted })
  }
  setPlaybackRate = elem => {
    this.setState({ playbackRate: parseFloat(elem.target.value) })
  }
  onPlay = () => {
  ...
  onSeekChange = elem => {
    this.setState({ played: parseFloat(elem.target.value) })
  }
  onSeekMouseUp = elem => {
    this.setState({ seeking: false })
    this.player.seekTo(parseFloat(elem.target.value))
  }
  onProgress = state => {
        ...
        <section className="section">
          ...
          <div className="player-wrapper">
            <ReactPlayer
              ...
              onSeek={elem => console.log('onSeek', elem)}
              onEnded={() => this.setState({ playing: loop })}
              onError={elem => console.log('onError', elem)}
